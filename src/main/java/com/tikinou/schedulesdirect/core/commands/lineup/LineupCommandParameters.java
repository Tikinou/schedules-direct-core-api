...
public class LineupCommandParameters extends AuthenticatedBaseCommandParameter {
    private String lineupId;

    public LineupCommandParameters(){
        this(null);
    }

    public LineupCommandParameters(String lineupId){
        this(null, lineupId);
    }

    public LineupCommandParameters(SchedulesDirectApiVersion version, String lineupId){
        super(version);
    ...
    public String toString() {
        return "LineupsCommandParameters{" + toStringMembers() + '}';
    }
