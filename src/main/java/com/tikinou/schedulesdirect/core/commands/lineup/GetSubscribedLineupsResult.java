 ...
 */
public class GetSubscribedLineupsResult extends BaseCommandResult {
    ...
    public String toString() {
        return "GetSubscribedLineupsResult{" + toStringMembers() + '}';
    }

    @Override
    protected String toStringMembers() {
        return super.toStringMembers() + ", lineups=" + (lineups != null ? Arrays.toString(lineups.toArray()) : lineups);
    }
}
